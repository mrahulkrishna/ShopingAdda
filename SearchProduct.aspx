<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.Master" AutoEventWireup="true" CodeBehind="SearchProduct.aspx.cs" Inherits="ShopingAdda.SearchProduct" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Body" runat="server">

								
 <asp:Panel ID="pnlProducts" runat="server"  Height="100%">
                      <asp:DataList ID="dlProduct" runat="server" RepeatColumns="1" align="center" Width="70%">
                        <ItemTemplate>
